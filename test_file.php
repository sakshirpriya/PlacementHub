...
<div class="row">
	<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 text-center" style="border: 1px solid grey;padding: 10px;">
		<img src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/201904/Hrithik_roshan.jpeg?OLcIzQf6Ftb3Q6vNniO3WmIQb_dfTEAV" width="120px" height="120px" style="border-radius: 50%" class="text-justify">
		<h5 class="text-center"><b>Nikhil Kumar Nikhil Kumar Dwivedi</b> </h5>
		<h4 class="text-center">c++</h4>
		<form class="form-inline">
 	
 	<div class="col text-center">
 		<button class="btn btn-info" data-toggle="modal" data-target="#editProfile" style="border-radius: 20px;border: 2px solid grey; width: 110px;"> Follow</button>
 		<button class="btn btn-info" data-toggle="modal" data-target="#editProfile" style="border-radius: 20px;border: 2px solid grey;width: 110px; ">Know More</button>
 	</div>
 	</form>
	</div>
	<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 text-center" style="border: 1px solid grey;padding: 10px;">
		<img src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/201904/Hrithik_roshan.jpeg?OLcIzQf6Ftb3Q6vNniO3WmIQb_dfTEAV" width="120px" height="120px" style="border-radius: 50%" class="text-justify">
		<h5 class="text-center"><b>Nikhil Kumar Dwivedi</b> </h5>
		<h4 class="text-center">c++</h4>
		<form class="form-inline">
...
<div class="row" style="border: 1px solid grey;">
	<div class="col-xl-2 col-lg-2 col-md-12 col-sm-12">
		<img src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/201904/Hrithik_roshan.jpeg?OLcIzQf6Ftb3Q6vNniO3WmIQb_dfTEAV" width="100%" height="200px"class="text-justify">
	</div>
	<div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
			<h3 ><i class="fa fa-user-circle-o" aria-hidden="true"></i><span style="margin-left: 10px;">Nikhil Kumar Dwivedi Singh Raghav</span></h3><hr>
		<h4 ><i class="fa fa-book" aria-hidden="true"></i><span style="margin-left: 10px;">c++</span></h4><hr>
		<h4 ><i class="fa fa-file-text" aria-hidden="true"></i><b style="margin-left: 10px;">AboutMe:</b>dnscidnsncjnc djsbhwbSCYU JNC WUBDCYWBX JH CUHWBYXBYX</h4>
	</div>
	<div class="col-xl-2 col-lg-2 col-md-12 col-sm-12">
	<div class="col text-center" style="margin-top: 30%;">
 		<button class="btn btn-info" data-toggle="modal" data-target="#editProfile" style="border-radius: 20px;border: 2px solid grey; width: 140px;"> Follow</button>
 		</div>
 		<div class="col text-center" style="margin-top: 10%;">
 		<button class="btn btn-info" data-toggle="modal" data-target="#editProfile" style="border-radius: 20px;border: 2px solid grey;width: 140px; ">Know More</button>
 	</div>
	</div>
</div>
