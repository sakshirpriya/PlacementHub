...
<div class="card-deck">
  <div class="card shadow-lg mb-5 bg-white rounded">
    ...
    <div class="card-body">
      ...
      <button type="button" class="btn btn-info btn-sm" style="margin-top: -30px;"><a href="take_test_mcq.php">TAKE NOW !!</a></button>
  ...
  <div class="card shadow-lg mb-5 bg-white rounded">
    ...
    <div class="card-body">
      ...
      <button type="button" class="btn btn-info btn-sm" style="margin-top: -30px;"><a href="take_test_eassay.php">TAKE NOW !!</a></button>
  </div>
