...
<div class="card-deck" style="margin-top: 5px;">
  <div class="card shadow-lg mb-5 bg-white rounded">
   ...
   <!--  <div class="card-body">
      ...
      <p class="card-text">
        <ul>
          <li>Look all mentors available.</li>
          <li>Check Category wise.</li>
          <li>Follow them in one click.</li>
        </ul>
      </p>
    </div> -->
   
      <button type="button" class="btn btn-info btn-sm" style="margin-top: -30px;"><a href="mentor_index.php">Click Here</a></button>
 
  </div>
  <div class="card shadow-lg mb-5 bg-white rounded">
    <button type="button" style="width: 100%;" class="btn btn-info btn-sm"><h3>GD Room</h3></button>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="scrollcards">
        ...
        <!-- Card Flip -->
        <div class="card-flip-five card-main">
          <div class="flip-five">
            <div class="front">
              <!-- front content -->
              <div class="card">
