...
$search_for_group="SELECT * from gd_request WHERE student_email='$student_email'";
$result=mysqli_query($conn,$search_for_group);
while($row=mysqli_fetch_array($result)){
  // echo $row["student_email"]."<br>";
  // echo $row["mentor_email"]."<br>";
  // echo $row["gd_room_name"]."<br>";
 $gd_room_name=$row["gd_room_name"];
 $search_for_group_details="SELECT * from gd_room_creator WHERE gd_room_name='$gd_room_name' AND feedback=false";
