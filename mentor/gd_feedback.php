...
$language=$_REQUEST["language_2"];
$content=$_REQUEST["content_2"];
$confidence=$_REQUEST["confidence_2"];
$attitude=$_REQUEST["attitude_2"];
$interaction=$_REQUEST["interaction_2"];
...
$language=$_REQUEST["language_3"];
$content=$_REQUEST["content_3"];
$confidence=$_REQUEST["confidence_3"];
$attitude=$_REQUEST["attitude_3"];
$interaction=$_REQUEST["interaction_3"];
...
$language=$_REQUEST["language_4"];
$content=$_REQUEST["content_4"];
$confidence=$_REQUEST["confidence_4"];
$attitude=$_REQUEST["attitude_4"];
$interaction=$_REQUEST["interaction_4"];
...
$language=$_REQUEST["language_5"];
$content=$_REQUEST["content_5"];
$confidence=$_REQUEST["confidence_5"];
$attitude=$_REQUEST["attitude_5"];
$interaction=$_REQUEST["interaction_5"];
